export function drawPalm(ctx) {
  ...
  // ✅ Dynamic proportional mapping based on canvas ratio
  const fx = w / 500, fy = h / 800;

  const lines = [
    { n: "Life", p: [[120*fx,700*fy],[60*fx,400*fy],[220*fx,650*fy]], c: glow },
    { n: "Head", p: [[100*fx,500*fy],[300*fx,400*fy],[420*fx,420*fy]], c: neon },
