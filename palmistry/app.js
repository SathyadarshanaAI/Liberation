...
const UI_I18N = {
  ...
  si:{title:'සත්‍ය දර්ශන හස්ත රේඛා විශ්ලේෂකය V5.3', lang:'භාෂාව:', left:'වම් අත', right:'දකුණු අත',
      ...
      analyze:'විශ්ලේෂණය', mini:'කෙටි වාර්තාව', full:'සම්පූර්ණ PDF', speak:'කියවන්න', ready:'සූදානම්.',
      inherited:'පාරම්පරාවෙන් ලැබුණු ප්‍රවණතා', present:'වත්මන් ක්‍රියාකාරකම්',
      lines:{Heart:'හෘද',Head:'ශිරස්',Life:'ජීවිත',Fate:'ඉරණමි',Health:'සෞඛ්‍ය',Marriage:'විවාහ'},
