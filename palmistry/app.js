...
const UI_I18N = {
  ...
  si:{title:'සත්‍යා දර්ශන හස්ත රේඛා විශ්ලේශකය V5.3', lang:'භාෂාව:', left:'වම් අත', right:'දකුණු අත',
      ...
      lines:{Heart:'හෘද රේඛාව',Head:'ශිරස් රේඛාව',Life:'ජීවිත රේඛාව',Fate:'නියත රේඛාව',Health:'සෞඛ්‍ය රේඛාව',Marriage:'විවාහ රේඛාව'},
  ...
  hi:{title:'सत्य दर्शन हस्तरेखा विश्लेषक V5.3', lang:'भाषा:', left:'बायां हाथ', right:'दायां हाथ',
      ...
      lines:{Heart:'हृदय रेखा',Head:'मस्तिष्क रेखा',Life:'जीवन रेखा',Fate:'भाग्य रेखा',Health:'स्वास्थ्य रेखा',Marriage:'विवाह रेखा'},
      reportTitle:'हस्तरेखा रिपोर्ट', leftHdr:'बायां', rightHdr:'दायां', details:'विवरण'},
  bn:{title:'সত্যদর্শন হস্তরেখা বিশ্লেষক V5.3', lang:'ভাষা:', left:'বাম হাত', right:'ডান হাত',
      ...
      lines:{Heart:'হৃদয় রেখা',Head:'মস্তিষ্ক রেখা',Life:'জীবন রেখা',Fate:'ভাগ্য রেখা',Health:'স্বাস্থ্য রেখা',Marriage:'বিবাহ রেখা'},
      reportTitle:'হস্তরেখা প্রতিবেদন', leftHdr:'বাম', rightHdr:'ডান', details:'বিস্তারিত'},
  ar:{title:'محلل خطوط الكف ساتيا دارشانا V5.3', lang:'اللغة:', left:'اليد اليسرى', right:'اليد اليمنى',
  ...
  es:{title:'Analizador de Líneas de la Mano Sathya Darshana V5.3', lang:'Idioma:', left:'Mano izquierda', right:'Mano derecha',
      ...
      reportTitle:'Informe de mano', leftHdr:'Izquierda', rightHdr:'Derecha', details:'Detalles'},
  fr:{title:'Analyse des Lignes de Main Sathya Darshana V5.3', lang:'Langue :', left:'Main gauche', right:'Main droite',
      ...
      reportTitle:'Rapport de main', leftHdr:'Gauche', rightHdr:'Droite', details:'Détails'},
  de:{title:'Sathya Darshana Handlinien-Analysator V5.3', lang:'Sprache:', left:'Linke Hand', right:'Rechte Hand',
      start:'Start', cap:'Aufnehmen', torch:'Lampe', upload:'Hochladen',
      analyze:'Analysieren', mini:'Kurzbericht', full:'Vollständiges PDF', speak:'Sprache', ready:'Bereit.',
      ...
      reportTitle:'Handlinien-Bericht', leftHdr:'Links', rightHdr:'Rechts', details:'Details'},
  ru:{title:'Анализатор Линий Ладони Сатья Даршана V5.3', lang:'Язык:', left:'Левая рука', right:'Правая рука',
  ...
  ja:{title:'サティヤ・ダルシャナ 手相解析 V5.3', lang:'言語:', left:'左手', right:'右手',
  ...
  'zh-CN':{title:'萨提亚·达尔沙那 手相分析 V5.3', lang:'语言：', left:'左手', right:'右手',
