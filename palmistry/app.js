...
const UI_I18N = {
  ...
  si:{title:'සත්‍ය දර්ශන හස්ත රේඛා විශ්ලේෂකය V5.3', lang:'භාෂාව:', left:'වම් අත', right:'දකුණු අත',
      start:'ආරම්භ', cap:'සටහන්', torch:'ටෝච්', upload:'ඡායාරූපය',
      analyze:'විශ්ලේෂණය', mini:'කෙටි වාර්තාව', full:'සම්පූර්ණ PDF', speak:'කියවන්න', ready:'සಿದ್ಧ.',
      inherited:'පෙර ආත්ම භාවයේ ලක්ෂණ', present:'මෙි ආත්ම භාවයේ ලක්ෂණ', 
      lines:{Heart:'හෘද',Head:'ශිරස්',Life:'ජීවිත',Fate:'නියත',Health:'සෞඛ්‍ය',Marriage:'ව්වාහ'},
      reportTitle:'හස්ත රේඛා වාර්තාව', leftHdr:'වම්', rightHdr:'දකුණු', details:'විස්තර'},
